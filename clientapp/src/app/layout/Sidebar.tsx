...
export const Sidebar = (props:SidebarProps) => {
  ...
  const demoItems:Array<{linkTo:string, title:string, cssClassName:string}> = [
    {
      title: 'Icons',
      cssClassName: '',
      linkTo: '/icons'
    ...
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul className="nav">
        <li className="nav-item">
          <a className="nav-link" href="https://github.com/savantly-net/horus" target="_blank" rel="noopener noreferrer">
